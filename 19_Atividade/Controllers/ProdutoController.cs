...
namespace _19_Atividade.Controllers
{
    public class ProdutoController : Controller
    {
        ...
        public async Task<IActionResult> Create([Bind("ProdutoId,Preco,Nome,Descricao,Imagem,Estoque")] Produto produto)
        {
        ...
        [HttpPost]
        [ValidateAntiForgeryToken]
        public async Task<IActionResult> Edit(int id, [Bind("ProdutoId,Preco,Nome,Descricao,Imagem,Estoque")] Produto produto)
        {
