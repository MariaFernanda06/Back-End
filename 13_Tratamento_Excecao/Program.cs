public class Program
{
    public static void Main()
    {
        ...
        //catch é o tratamento do erro, normalmente colocamos as mensagens de acordo com o tipo do erro,
        //para melhor compreensão do usuário  
        catch (Exception erro)
        {
            Console.WriteLine($"Ocorreu um erro: {erro.Message}");
        }
        //o finaly é um bloco executado independentemente se ocorrer erro ou não
        finally
        {
            Console.WriteLine("Entrando no finaly");
        }
    } 
}